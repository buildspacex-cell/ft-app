...
function WishQuestion({ dark = false, defaultCountry = 'IN' }: { dark?: boolean; defaultCountry?: string }) {
  ...
  if (saved) return (
    <div>
      ...
      <PhoneStep dark={dark} defaultCountry="US" />
    </div>
  )
  ...
  return (
    <>
      ...
      <div className="ft-landing">
          ...
          <div className="ft-wrap">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }} className="ft-hero-split">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                {[
                  { icon: '01', phase: 'Before you buy', headline: 'Should I even own this?', body: 'Five questions about any stock. Plain English. No jargon.', active: false },
                  ...
                  { icon: '03', phase: 'When to leave', headline: 'Is it time to go?', body: 'When your reason breaks or the price turns, we tell you. Not a tip. Just the facts.', active: false },
                ].map(m => (
        ...
        {/* ── PRODUCT IN ACTION ── */}
        <section style={{ padding: '72px 0', background: 'var(--paper)', borderTop: '1px solid var(--hairline)', borderBottom: '1px solid var(--hairline)', marginTop: 0 }}>
