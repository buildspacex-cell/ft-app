          ...
          <div className="ft-wrap">
            ...
            <div className="ft-steps">
              {[
                ...
                { n: '03', h: 'Check whether those reasons still hold.', p: "When the RBI moves rates, when oil spikes, when a monsoon forecast drops - we check if any of it touches a reason in your thesis. Every morning. Not just on earnings day.", badge: 'We watch · you decide' },
              ].map(s => (
