                ...
                <div style={{ margin: '0 0 28px', maxWidth: 500 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 0, marginBottom: 24 }}>
                    {[
                      ...
                      { n: '02', label: 'While you hold', text: 'Every morning we check if anything changed. Results, RBI decisions, headlines, sector news. We filter all of it against your specific reason for owning each stock. If it touches your reason, we tell you in plain English. If it does not, we stay quiet. Most mornings, we stay quiet.' },
        ...
        <section id="moments" className="ft-section" style={{ borderTop: '1px solid var(--hairline)' }}>
          <div className="ft-wrap">
            ...
            <p style={{ fontSize: 19, color: 'var(--ink-soft)', maxWidth: 640, margin: '0 0 56px', lineHeight: 1.45 }}>
              Most finance apps help you pick a stock and disappear. FT stays — from the first question to the last decision.
            </p>
            <div className="ft-moments">
              {[
                ...
                },
                {
                  ...
                  body: 'Every morning we scan everything — news, results, macro moves, price — and check if any of it touches the specific reason you own each stock. If nothing changed, we stay quiet. Most mornings, we stay quiet.',
                  current: true,
                },
                {
                  phase: 'When to leave',
